import { Users, FileText, ChevronRight, LogOut, User, Settings, LayoutDashboard, AlertCircle, Files } from 'lucide-react';
import { useEffect, useState } from 'react';
import { useLocation, Link } from 'wouter';

import AdminTaxFormDocuments from '@/features/admin/components/AdminTaxFormDocuments';
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1">
          ...
          <main className="flex-1 p-6 overflow-auto">
            ...
            <TabsContent value="files">
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <h2 className="text-2xl font-bold">File Library</h2>
                  <Button className="bg-blue-600 hover:bg-blue-700">
                    <Files className="mr-2 h-4 w-4" />
                    Upload Files
                  </Button>
                ...
                <p className="text-muted-foreground">
                  Manage all uploaded files including documents, images, and other assets. View, download, and organize files with bulk operations.
                </p>
                <div className="mt-6">
